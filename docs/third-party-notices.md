...
The installed `Mihomo-Release.txt` records the binary archive URL, binary checksum, exact Corresponding Source URL, source archive URL, upstream project, architecture, and the independent license boundary.
